...
function getCall() {
    ...
    _.each(params, function(param) {
        ...
        var parentIndex =
            parentParam == null
                ? -1
                : _.findIndex(params, function(param) {
 ...
 */
function getName() {
    return hasTag(this, 'name') ? getValue(this, 'name') : _.toString(_.first(this.getCall().split('(')))
}
...
function getType() {
    ...
    return /^(?:array|function|object|regexp)$/.test(result) ? _.capitalize(result) : result
}
 ...
 */
function isPrivate() {
    return this.isLicense() || hasTag(this, 'private') || _.isEmpty(this.parsed.tags)
}
